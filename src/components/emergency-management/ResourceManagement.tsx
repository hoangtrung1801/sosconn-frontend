              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-950/20 dark:to-blue-950/20 p-6 rounded-lg">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-lg">AI Deployment Recommendations</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Optimized resource allocation based on current emergency patterns
                      </p>
                    </div>
                  </div>
                          ...
                          {lowStockResources.slice(0, 3).map(resource => (
                            <div key={resource.id} className="flex justify-between items-center text-sm">
                              <span className="text-red-700 dark:text-red-300">
                                {resource.name} - {resource.availableQuantity} remaining
                              </span>
                              <Badge variant="destructive" className="text-xs">
                                {Math.round((resource.availableQuantity / resource.quantity) * 100)}% left
                              </Badge>
                            </div>
                          ))}
                        </div>
                      ...
                      <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 rounded-lg p-4">
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-green-600">12% faster</span>
                          </div>
                          <div className="flex justify-between">
                          ...
                          <div className="text-xs text-blue-700 dark:text-blue-300 mt-2">
                            AI suggests redistributing 3 ambulances to high-risk areas for optimal coverage
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 rounded-lg p-4">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium text-orange-600">Critical in 4h</span>
                          </div>
                          <div className="text-xs text-green-700 dark:text-green-300 mt-2">
                            Pre-position resources at Community Centers A & B before evening rush
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <Card>
                    <CardContent className="p-4">
                      ...
                      <div className="text-2xl font-bold text-blue-600">7.3m</div>
                      <p className="text-xs text-gray-600">15% improvement</p>
                    </CardContent>
                  </Card>
